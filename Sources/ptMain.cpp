...
#ifdef Q_OS_WIN
  // On Windows you can wither always or never get a console window. I.e. you either get an annoying
...
#ifdef Q_OS_WIN
  // Close output channels to a possibly attached console. Not sure if this is strictly necessary,
