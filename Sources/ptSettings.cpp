...
ptSettings::ptSettings(const short InitLevel, const QString Path) {
  ...
  const ptGuiChoiceItem GuiChoiceItems[] = {
    ...
    {"ResizeMode"                  ,ptGT_Choice       ,2,1,1 ,ptResizeMode_LongerSide     ,GuiOptions->ResizeMode                ,tr("Mode for resizing")},
    ...
    {"WebResizeMode"               ,ptGT_Choice       ,2,1,1 ,ptResizeMode_LongerSide     ,GuiOptions->ResizeMode                ,tr("Mode for resizing")},
