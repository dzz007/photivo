...
void ptFilterDM::TranslateSpecialToNew(QSettings *APreset, QStringList *AKeys) {
  ...
  */
  ...
  for (QString hOldMaskKey: hToneMaskKeys) {
    auto hComboIdx = APreset->value(hOldMaskKey, -9999).toInt() - 1;
    if (hComboIdx == -10000) {
...
//  FNameMap.insert("LevelsBlackPoint",                "");
//  FNameMap.insert("LevelsWhitePoint",                "");
//  FNameMap.insert("LabLevelsBlackPoint",             "");
//  FNameMap.insert("LabLevelsWhitePoint",             "");
...
//  FNameMap.insert("Vibrance",                        "");
//  FNameMap.insert("IntensityRed",                    "");
//  FNameMap.insert("IntensityGreen",                  "");
//  FNameMap.insert("IntensityBlue",                   "");
//  FNameMap.insert("ColorEnhanceShadows",             "");
//  FNameMap.insert("ColorEnhanceHighlights",          "");
...
//  FNameMap.insert("ExposureGain",                    "");
//  FNameMap.insert("Reinhard05Brightness",            "");
//  FNameMap.insert("Reinhard05Chroma",                "");
//  FNameMap.insert("Reinhard05Light",                 "");
//  FNameMap.insert("CatchWhite",                      "");
//  FNameMap.insert("CatchBlack",                      "");
//  FNameMap.insert("LMHLightRecovery1Amount",         "");
//  FNameMap.insert("LMHLightRecovery1LowerLimit",     "");
//  FNameMap.insert("LMHLightRecovery1UpperLimit",     "");
//  FNameMap.insert("LMHLightRecovery1Softness",       "");
//  FNameMap.insert("LMHLightRecovery2Amount",         "");
//  FNameMap.insert("LMHLightRecovery2LowerLimit",     "");
//  FNameMap.insert("LMHLightRecovery2UpperLimit",     "");
//  FNameMap.insert("LMHLightRecovery2Softness",       "");
...
//  FNameMap.insert("DRCBeta",                         "");
//  FNameMap.insert("DRCAlpha",                        "");
//  FNameMap.insert("DRCColor",                        "");
//  FNameMap.insert("LabLMHLightRecovery1Amount",      "");
//  FNameMap.insert("LabLMHLightRecovery1LowerLimit",  "");
//  FNameMap.insert("LabLMHLightRecovery1UpperLimit",  "");
//  FNameMap.insert("LabLMHLightRecovery1Softness",    "");
//  FNameMap.insert("LabLMHLightRecovery2Amount",      "");
//  FNameMap.insert("LabLMHLightRecovery2LowerLimit",  "");
//  FNameMap.insert("LabLMHLightRecovery2UpperLimit",  "");
//  FNameMap.insert("LabLMHLightRecovery2Softness",    "");
...
//  FNameMap.insert("NormalizationOpacity",            "");
...
//  FNameMap.insert("SaturationAmount",                "");
//  FNameMap.insert("ColorBoostValueA",                "");
//  FNameMap.insert("ColorBoostValueB",                "");
...
//  FNameMap.insert("LABToneSaturation",               "");
//  FNameMap.insert("LABToneAmount",                   "");
//  FNameMap.insert("LABToneHue",                      "");
//  FNameMap.insert("LABToneSSaturation",              "");
//  FNameMap.insert("LABToneSAmount",                  "");
//  FNameMap.insert("LABToneSHue",                     "");
//  FNameMap.insert("LABToneMSaturation",              "");
//  FNameMap.insert("LABToneMAmount",                  "");
//  FNameMap.insert("LABToneMHue",                     "");
//  FNameMap.insert("LABToneHSaturation",              "");
//  FNameMap.insert("LABToneHAmount",                  "");
//  FNameMap.insert("LABToneHHue",                     "");
...
//  FNameMap.insert("Vibrance2",                       "");
//  FNameMap.insert("Intensity2Red",                   "");
//  FNameMap.insert("Intensity2Green",                 "");
//  FNameMap.insert("Intensity2Blue",                  "");
...
//  FNameMap.insert("LABTransform",                    "");
//  FNameMap.insert("LMHLightRecovery1MaskType",       "");
//  FNameMap.insert("LMHLightRecovery2MaskType",       "");
//  FNameMap.insert("Microcontrast1MaskType",          "");
//  FNameMap.insert("Microcontrast2MaskType",          "");
//  FNameMap.insert("LabLMHLightRecovery1MaskType",    "");
//  FNameMap.insert("LabLMHLightRecovery2MaskType",    "");
